    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('permissao.store')}}" id="add_user" method='POST'>
                    {{csrf_field()}}

                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="nome">Permissão</label>
                            <input type="text" name="nome" class='form-control' id="nome" placeholder="Adicione uma permissão" required>
                        </div>
                    </div>
